import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getRequestProtocol, getRequestHost, setHeader, getHeader, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/h3/dist/index.mjs';
import destr from 'file:///home/runner/work/_temp/my-sites-template/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/node-mock-http/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, withBase, withTrailingSlash, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/ufo/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/runner/work/_temp/my-sites-template/node_modules/unstorage/drivers/fs.mjs';
import crypto from 'node:crypto';
import fsDriver from 'file:///home/runner/work/_temp/my-sites-template/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///home/runner/work/_temp/my-sites-template/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/radix3/dist/index.mjs';
import { toValue } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1 } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/pathe/dist/index.mjs';
import { createConsola } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/consola/dist/index.mjs';
import { createFilter } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/nuxtseo-shared/dist/utils.mjs';
import { XMLParser } from 'file:///home/runner/work/_temp/my-sites-template/node_modules/fast-xml-parser/src/fxp.js';

const serverAssets = [{"baseName":"server","dir":"/home/runner/work/_temp/my-sites-template/server/assets"}];
...
const _47home_47runner_47work_47_temp_47my_45sites_45template_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('internal:nuxt:prerender', _47home_47runner_47work_47_temp_47my_45sites_45template_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/home/runner/work/_temp/my-sites-template/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/home/runner/work/_temp/my-sites-template/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/runner/work/_temp/my-sites-template","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/runner/work/_temp/my-sites-template/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/runner/work/_temp/my-sites-template/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/runner/work/_temp/my-sites-template/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "bf150133-1ce0-4561-b572-4f11c91b9e11",
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "url": "https://abitprojetos.com",
        "name": "ABIT Projetos & Engenharia"
      }
    ],
    "version": "4.0.8",
    "debug": false,
...
const _qH1HzvVjui_2BV6ApDfvvyD8ITMAInZjE4u5Ow4MSgg = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _qH1HzvVjui_2BV6ApDfvvyD8ITMAInZjE4u5Ow4MSgg
];
...
const _UllLJy = eventHandler((event) => {
...
const _lMHnb4 = eventHandler(async (e) => {
...
const _4fc4nl = defineEventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///home/runner/work/_temp/my-sites-template/node_modules/fast-xml-parser/src/fxp.js');
...
const _jGaFJs = defineEventHandler(sitemapXmlEventHandler);

const _lazy_8OK7l3 = () => import('../_/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _UllLJy, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _lMHnb4, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _4fc4nl, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _jGaFJs, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8OK7l3, lazy: true, middleware: false, method: undefined }
];
