...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div></div><div class="footer-bottom"><p>\xA9 ${ssrInterpolate(unref(year))} ABIT Projetos &amp; Engenharia. Todos os direitos reservados.</p><a href="https://www.code7.tec.br" target="_blank" rel="noopener" class="footer-credit">Desenvolvido por code7</a></div></footer>`);
    };
  }
});
...
//# sourceMappingURL=index-73TcU-kj.mjs.map
