...
import { _ as __nuxt_component_0 } from './nuxt-link-vjo15m1U.mjs';
...
import { a as useRuntimeConfig, _ as _export_sfc, b as useRequestEvent, u as useNuxtApp } from './server.mjs';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtImg = _sfc_main$9;
      _push(`<section${ssrRenderAttrs(mergeProps({ id: "sobre" }, _attrs))} data-v-e8257a5e><div class="section" data-v-e8257a5e><div class="about-grid" data-v-e8257a5e><div class="about-img-wrap fade-in" data-v-e8257a5e>`);
      if (unref(aboutData).teamPhoto) {
        ...
        _push(`<div class="about-img-placeholder" data-v-e8257a5e><i class="fas fa-hard-hat" data-v-e8257a5e></i><p data-v-e8257a5e>Adicione uma foto da equipe aqui</p></div>`);
      }
      _push(`<div class="about-accent" data-v-e8257a5e></div></div><div class="fade-in" style="${ssrRenderStyle({ "transition-delay": "0.15s" })}" data-v-e8257a5e><div class="section-label" data-v-e8257a5e>${ssrInterpolate(unref(aboutData).label)}</div><h2 class="section-title" data-v-e8257a5e>${ssrInterpolate(unref(aboutData).title)} <span data-v-e8257a5e>${ssrInterpolate(unref(aboutData).titleHighlight)}</span></h2><p style="${ssrRenderStyle({ "font-size": "15px", "line-height": "1.8", "color": "rgba(245,240,232,0.6)", "margin-bottom": "8px" })}" data-v-e8257a5e>${ssrInterpolate(unref(aboutData).description)}</p><ul class="about-check-list" data-v-e8257a5e><!--[-->`);
      ssrRenderList(unref(aboutData).checklist, (item) => {
        _push(`<li data-v-e8257a5e><i class="fas fa-check" data-v-e8257a5e></i> ${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul><a${ssrRenderAttr("href", unref(whatsappUrl))} class="btn-primary" target="_blank" rel="noopener" style="${ssrRenderStyle({ "display": "inline-flex" })}" data-v-e8257a5e><i class="fab fa-whatsapp" data-v-e8257a5e></i> ${ssrInterpolate(unref(aboutData).ctaLabel)}</a></div></div></div></section>`);
    };
  }
});
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-e8257a5e"]]);
...
//# sourceMappingURL=index-DSbEcpWH.mjs.map
